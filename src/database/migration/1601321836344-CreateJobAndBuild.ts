...
export class CreateJobAndBuild1601321836344 implements MigrationInterface {
  name = 'CreateJobAndBuild1601321836344'

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`CREATE TABLE "job" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "name" varchar NOT NULL, "description" varchar)`)
